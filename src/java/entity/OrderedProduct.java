...
@NamedQueries({
    ...
    @NamedQuery(name = "OrderedProduct.findByProductsId", query = "SELECT o FROM OrderedProduct o WHERE o.orderedProductPK.productsId = :productsId"),
...
public class OrderedProduct implements Serializable {
    ...
    public OrderedProduct(int customerOrderId, int productsId) {
        this.orderedProductPK = new OrderedProductPK(customerOrderId, productsId);
    }
