        ...
        <div id="centerColumn">
            ...
            <c:choose>
                <c:when test="${cart.numberOfItems > 1}">
                    <p float="left">Your shopping cart contains ${cart.numberOfItems} items.</p>
                </c:when>
                <c:when test="${cart.numberOfItems == 1}">
                    <p float="left">Your shopping cart contains ${cart.numberOfItems} item.</p>
                </c:when>
                <c:otherwise>
                    <p float="left">Your shopping cart is empty.</p>
                </c:otherwise>
            </c:choose>
